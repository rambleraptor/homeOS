...
async function syncResources(
  ...
  try {
    const { getAllResourceDefs } = await import('../registry/registry');
...
async function syncModuleFlags(
  ...
  try {
    const { getAllModuleFlagDefs } = await import('../registry/registry');
...
async function syncUserSettings(
  ...
  try {
    const { getAllUserSettingDefs } = await import('../registry/registry');
