/**
 * Catch-all module renderer for the SPA.
 *
 * React Router hands us the current path; we resolve it to a module route
...
import {
  buildRouteEntries,
  matchRoute,
} from '@rambleraptor/homestead-core/modules/router/match';
