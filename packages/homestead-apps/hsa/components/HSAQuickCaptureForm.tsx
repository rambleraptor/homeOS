 ...
 *
 * Form for adding new HSA receipts by hand. AI extraction lives in the
 * Documents app now: uploading a receipt there classifies it as a
 * `medical-receipt` and mirrors it into HSA automatically (see
 * documents/doc-types/post-classify/medical-receipt.server.ts). This form is
 * the manual path for a receipt you'd rather key in directly.
 */
