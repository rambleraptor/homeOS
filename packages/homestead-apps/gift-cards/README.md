...
The Gift Cards app allows you to manage and track household gift cards, organizing them by merchant and keeping track of balances.
...
The app uses a `gift-card` aepbase resource (see `resources.ts`)
...
- **GiftCardHome**: Main component that orchestrates the entire app
